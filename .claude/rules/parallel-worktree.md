...
## ワークツリー構成（CLAUDE.md §2 参照）

| ワークツリー | ブランチ | 用途 |
|---|---|---|
| main | main | 本番（直接コミット非推奨） |
| kesson-space-develop | develop | 目視確認ゲート・ステージング |
| kesson-codex-1〜3 | feature/codex-1〜3 | Codex App 実装用 |
| kesson-space-gemini-1 | gemini-dev | Gemini CLI 実装・実験 |
