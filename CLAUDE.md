...
| **develop（常設）** | `/Users/uminomae/dev/kesson-space-develop` | develop | 目視確認ゲート・ステージング（常時起動可） |
| Codex App (旧staging) | `/Users/uminomae/dev/kesson-codex-app` | dev | 旧ステージング（develop に移行） |
