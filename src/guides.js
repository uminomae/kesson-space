...
function renderFeatureCards() {
    ...
    // CHANGED(2026-03-25): #161 — Overview slide card (first position)
    const overviewCol = document.createElement('div');
    overviewCol.className = 'col';
    const overviewCard = document.createElement('article');
    overviewCard.className = 'card kesson-card h-100 overview-slide-card';
    ...
    fragment.appendChild(overviewCol);
