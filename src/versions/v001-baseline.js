// v001-baseline: Gemini初版（2026-02-11 Session #1）
// 判定: ◎ ベースライン採用
// プロンプト: P001
...
// --- オブジェクトの配置 ---
const warmColors = [0xff5533, 0xff8833, 0xffaa55];
const coolColors = [0x3366ff, 0x44aaff, 0x55ccff];
const kessonMeshes = [];
