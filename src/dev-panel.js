...
const SECTIONS = [
    ...
    },
    {
        ...
        params: {
            ...
            vortexColorR:         { label: '色 R',           min: 0.0,  max: 2.0,   step: 0.05, default: vortexParams.colorR },
            vortexColorG:         { label: '色 G',           min: 0.0,  max: 2.0,   step: 0.05, default: vortexParams.colorG },
            vortexColorB:         { label: '色 B',           min: 0.0,  max: 2.0,   step: 0.05, default: vortexParams.colorB },
            vortexIterations:     { label: 'ループ回数',     min: 10,   max: 50,    step: 5,    default: vortexParams.iterations },
            vortexInnerIterLimit: { label: '内側ループ上限', min: 50,   max: 500,   step: 50,   default: vortexParams.innerIterLimit },
